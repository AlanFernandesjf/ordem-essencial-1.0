...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // @ts-ignore: creditResult is JSON
    const creditsRemaining = creditResult.remaining;
    ...
    if (type === 'diet') {
      ...
      5. Distribua as calorias de forma lógica ao longo do dia (ex: mais calorias no almoço/jantar, menos nos lanches).
      6. Para ganho de massa, foque em superávit calórico controlado e proteína adequada (1.6g a 2.2g/kg).
      7. Para perda de peso, foque em déficit moderado e alta saciedade (fibras e proteínas).
